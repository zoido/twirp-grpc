...
def go_repositories():
    ...
    go_repository(
        name = "com_github_zoido_yag_config",
        importpath = "github.com/zoido/yag-config",
        sum = "h1:9ypFiH7qsxb0WssrKXrvBNXRTE8PzJMnz6yxNabgZnc=",
        version = "v0.0.0-20200507201423-44a378526a03",
    )
    go_repository(
